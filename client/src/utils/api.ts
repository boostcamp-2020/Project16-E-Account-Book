...
export const GET_TEST_TOKEN = (id: number): string =>
...
export const GET_TRANSACTION_SOCIAL_LIST = (bookId: number, year: number, month: number): string =>
  `${process.env.REACT_APP_BASE_URL}/api/social/transaction/${bookId}/${year}/${month}`;

export const GET_TRANSACTION_PRIVATE_LIST = (year: number, month: number): string =>
  `${process.env.REACT_APP_BASE_URL}/api/private/transaction/${year}/${month}`;

export const GET_MY_USER_INFO = `${process.env.REACT_APP_BASE_URL}/api/user/myInfo`;
...
export const GET_SOCIAL_FOUR_MONTH_STATISTICS = (bookId: number): string =>
  `${process.env.REACT_APP_BASE_URL}/api/social/statistic/monthly/${bookId}`;
...
export const GET_PRIVATE_ANALYSIS = `${process.env.REACT_APP_BASE_URL}/api/private/statistic/analysis`;

export const GET_PRIVATE_FOUR_MONTH_STATISTICS = `${process.env.REACT_APP_BASE_URL}/api/private/statistic/monthly/`;
...
export const POST_CREATE_SOCIAL = `${process.env.REACT_APP_BASE_URL}/api/social`;
